...
module.exports = async (page, scenario, vp) => {
    ...
    await page.waitForSelector(beforeStartComponents.RADIO_BUTTON_NO,{visible:true});
    console.log(beforeStartComponents.RADIO_BUTTON_NO,{visible:true})
    await page.click(beforeStartComponents.RADIO_BUTTON_NO);
